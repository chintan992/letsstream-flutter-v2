        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Cast section
              Text('Top Billed Cast', style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 8),
              SizedBox(
                height: 160,
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final imageUrl = (c.profilePath != null && c.profilePath!.isNotEmpty)
                            ...
                            : null;
                        return Semantics(
                          label: '${c.name}${c.character != null && c.character!.isNotEmpty ? ' as ${c.character}' : ''}',
                          child: SizedBox(
                          width: 100,
                          child: Column(
                            children: [
              ...
              const SizedBox(height: 24),
              // Trailers section
              Text('Trailers', style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 8),
              SizedBox(
                height: 120,
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final thumbUrl = 'https://img.youtube.com/vi/${v.key}/0.jpg';
                        return Semantics(
                          ...
                          onTap: () async {
                            final url = Uri.parse('https://www.youtube.com/watch?v=${v.key}');
                                ...
                                child: Stack(
                                  children: [
                                    CachedNetworkImage(
                                      ...
                                      height: 90,
                                      fit: BoxFit.cover,
                                      placeholder: (context, url) => const ShimmerBox(width: 160, height: 90),
                                      errorWidget: (context, url, error) => Container(
                                        color: Theme.of(context).colorScheme.surfaceContainerHighest,
