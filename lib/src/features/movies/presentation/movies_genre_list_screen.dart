...
class MoviesGenreListScreen extends ConsumerStatefulWidget {
  ...
  const MoviesGenreListScreen({super.key, required this.genreId, required this.genreName});

  @override
  ConsumerState<MoviesGenreListScreen> createState() => _MoviesGenreListScreenState();
}
...
class _MoviesGenreListScreenState extends ConsumerState<MoviesGenreListScreen> {
  ...
  Future<void> _load() async {
    ...
    final pageItems = await repo.getMoviesByGenre(widget.genreId, page: _page);
    setState(() {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          ...
          if (_items.isEmpty) return const EmptyState(message: 'No movies in this genre', icon: Icons.category_outlined);
          ...
          return RefreshIndicator(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  context.pushNamed('movie-detail', pathParameters: {'id': m.id.toString()}, extra: m);
                },
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: url != null
